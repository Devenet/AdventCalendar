...
abstract class I18n {
	static $translations = [
		...
		'developed-by' => [ 'en' => 'Developed with love by {arg}', 'fr' => 'Développé par {arg}', 'de' => 'Developed by {arg}' ],
...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="notice">
				<a href="https://github.com/Devenet/AdventCalendar" rel="external"><?php echo ADVENT_CALENDAR; ?></a> &middot; Version <?php echo implode('.', array_slice(explode('.', VERSION), 0, 2)); ?>+demo
